...
object FakeData {
    ...
    val testMealsOfMinProteinAndTotalFat= listOf(
        Meal(mealId = 1, tags = listOf("dinner"), nutrition = Nutrition(carbohydrates = 5.0f, protein = 14.0f, totalFat = 15.0f)) ,
        Meal(mealId = 2, tags = listOf("lunch"), nutrition = Nutrition(carbohydrates = 5.0f, protein = 20.0f, totalFat = 11.0f),),
        Meal(mealId = 3, tags = listOf("lunch"), nutrition = Nutrition(carbohydrates = 9.5f, protein = 15.0f, totalFat = 12.0f))
    )
